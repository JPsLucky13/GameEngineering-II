...
function BuildAssets()
	...
	do
		...
		-- Mesh shaders
		do
			local shader_authored = EngineSourceContentDir .. "Shaders/Vertex/mesh.cgfx"
			local shader_built = GameInstallDir .. "data/Shaders/Vertex/mesh.shd"
			CreateDirectoryIfItDoesntExist( shader_built )
			local command = "\"" .. path_shaderBuilder .. "\""
				.. " \"" .. shader_authored .. "\" \"" .. shader_built .. "\" vertex"
			local result, exitCode = ExecuteCommand( command )
		...
		do
			local shader_authored = EngineSourceContentDir .. "Shaders/Fragment/mesh.cgfx"
			local shader_built = GameInstallDir .. "data/Shaders/Fragment/mesh.shd"
			CreateDirectoryIfItDoesntExist( shader_built )
			local command = "\"" .. path_shaderBuilder .. "\""
				.. " \"" .. shader_authored .. "\" \"" .. shader_built .. "\" fragment"
			local result, exitCode = ExecuteCommand( command )
		...
		if EAE6320_PLATFORM_D3D then
			...
			do
				local shader_authored = EngineSourceContentDir .. "Shaders/Vertex/vertexInputLayout_geometryMesh.cgfx"
				local shader_built = GameInstallDir .. "data/Shaders/Vertex/vertexInputLayout_geometryMesh.shd"
				CreateDirectoryIfItDoesntExist( shader_built )
				local command = "\"" .. path_shaderBuilder .. "\""
					.. " \"" .. shader_authored .. "\" \"" .. shader_built .. "\" vertex"
				local result, exitCode = ExecuteCommand( command )
	...
	do
		local path_textureBuilder = OutputDir .. "TextureBuilder.exe"
		do
			local texture_authored = EngineSourceContentDir .. "Textures/texture6.png"
			local texture_built = GameInstallDir .. "data/Textures/texture6.png"
			CreateDirectoryIfItDoesntExist( texture_built )
			local command = "\"" .. path_textureBuilder .. "\""
				.. " \"" .. texture_authored .. "\" \"" .. texture_built
			local result, exitCode = ExecuteCommand( command )
	...
	do
		local path_textureBuilder = OutputDir .. "TextureBuilder.exe"
		do
			local texture_authored = EngineSourceContentDir .. "Textures/Pumpkin.png"
			local texture_built = GameInstallDir .. "data/Textures/Pumpkin.png"
			CreateDirectoryIfItDoesntExist( texture_built )
			local command = "\"" .. path_textureBuilder .. "\""
				.. " \"" .. texture_authored .. "\" \"" .. texture_built
			local result, exitCode = ExecuteCommand( command )
	...
	do
		...
		do
			local mesh_authored = EngineSourceContentDir .. "Meshes/MovableMesh.lua"
			local mesh_built = GameInstallDir .. "data/Meshes/MovableMesh.fbx"
	...
	do
		local path_meshBuilder = OutputDir .. "MeshBuilder.exe"
		do
			local mesh_authored = EngineSourceContentDir .. "Meshes/StaticMesh.lua"
			local mesh_built = GameInstallDir .. "data/Meshes/StaticMesh.fbx"
			CreateDirectoryIfItDoesntExist( mesh_built )
			local command = "\"" .. path_meshBuilder .. "\""
				.. " \"" .. mesh_authored .. "\" \"" .. mesh_built
			local result, exitCode = ExecuteCommand( command )
	...
	do
		local path_meshBuilder = OutputDir .. "MeshBuilder.exe"
		do
			local mesh_authored = EngineSourceContentDir .. "Meshes/SecondStaticMesh.lua"
			local mesh_built = GameInstallDir .. "data/Meshes/SecondStaticMesh.fbx"
			CreateDirectoryIfItDoesntExist( mesh_built )
			local command = "\"" .. path_meshBuilder .. "\""
				.. " \"" .. mesh_authored .. "\" \"" .. mesh_built
			local result, exitCode = ExecuteCommand( command )
	...
	do
		local path_meshBuilder = OutputDir .. "MeshBuilder.exe"
		do
			local mesh_authored = EngineSourceContentDir .. "Meshes/PumpkinMesh.lua"
			local mesh_built = GameInstallDir .. "data/Meshes/PumpkinMesh.fbx"
			CreateDirectoryIfItDoesntExist( mesh_built )
			local command = "\"" .. path_meshBuilder .. "\""
				.. " \"" .. mesh_authored .. "\" \"" .. mesh_built
			local result, exitCode = ExecuteCommand( command )
